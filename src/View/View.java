...
public class View implements Observer {
    ...
    public View(Game model) {
        ...
        nextPiecesPanel.setBorder(BorderFactory.createEmptyBorder(100, 20, 100, 20)); // Padding autour du panneau
        nextPiecesPanel.setBackground(backgroundColor.brighter());
        nextPiecesPanel.setPreferredSize(new Dimension(200, screenHeight));
